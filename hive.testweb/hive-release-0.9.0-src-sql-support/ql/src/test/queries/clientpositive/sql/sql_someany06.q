...
select a,b,c,d,e from t1 where d = some (select z from t3 where y = 'world1' or y = 'world2' or y = 'world3');
select a,b,c,d,e from t1 where d = any (select z from t3 where y = 'world1' or y = 'world2' or y = 'world3');
