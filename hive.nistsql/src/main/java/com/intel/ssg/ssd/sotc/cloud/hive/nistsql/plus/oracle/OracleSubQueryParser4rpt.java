...
public class OracleSubQueryParser4rpt {
	...
	static String getRPTStar(String line) {
		String[] s = line.split("\",\"");
		return s[2];
	}
...
//				System.out.println("ALL SUB QUERY:    " + count + "   " + line);
	...
	public static void printSub() throws Exception {
		...
		System.out.println("successful sql sub query:" + (total-hql));
		System.out.println("pass rate:" + (float)(total-hql)/(float)total);
		System.out.println("failed sql sub query:" + sql
				+ ", include incorrect result:" + sqld);
		System.out.println("successful sql sub query:" + (total-sql));
		System.out.println("pass rate:" + (float)(total-sql)/(float)total);
	...
	public static void printMulti() throws Exception {
		...
		System.out.println("failed hql MULTI TABLE query:" + hql
				+ ", include incorrect result:" + hqld);
		System.out.println("successful sql MULTI TABLE query:" + (total-hql));
		System.out.println("pass rate:" + (float)(total-hql)/(float)total);
		System.out.println("failed sql MULTI TABLE query:" + sql
				+ ", include incorrect result:" + sqld);
		System.out.println("successful sql MULTI TABLE query:" + (total-sql));
		System.out.println("pass rate:" + (float)(total-sql)/(float)total);
